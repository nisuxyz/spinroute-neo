...
import { text, timestamp, uuid, jsonb, pgSchema, index, pgEnum } from 'drizzle-orm/pg-core';

export const fleetSchema = pgSchema('fleet');

export const fleetVehicleType = pgEnum('vehicle_type', ['bike', 'ebike', 'scooter', 'mo']);
